...
voltage <- as.numeric(data_clean$Voltage)
GRP_val <- as.numeric(data_clean$Global_reactive_power)
...
plot(fechas, GAP_val, type="l", xlab="", ylab="Global Active Power", cex=0.2)
plot(fechas, voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(fechas, GRP_val, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
